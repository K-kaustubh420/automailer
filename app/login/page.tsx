...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    if (!email || !password) return alert("Please enter both credentials");
    
    setLoading(true);
    
    // Store credentials in cookies so the API route can access them
      ...
      <div className="flex flex-col items-center justify-center mt-20 px-4">
        <div className="w-full max-w-[440px]">
          ...
          <div className="space-y-3">
            ...
            {/* Google Button */}
            <button className="w-full py-3 rounded-xl bg-[#cecece] text-[#1a1a1a] flex items-center justify-center gap-3 hover:bg-[#d4d4d4] transition-all font-bold">
